...
echo "<br>Daftar karyawan dengan pengalaman kerja lebih dari 5 tahun: <br>".implode(',',$karyawanPengalamanLimaTahun);
$daftarNilai = [
    'Matematika' => [
        ['Alice',85],
        ['Bob',92],
...
echo "<br>Siswa dengan nilai di atas rata-rata:<br>";
foreach ($daftarnilai as $siswa) {
    if ($siswa[1] > $ratarata) {
